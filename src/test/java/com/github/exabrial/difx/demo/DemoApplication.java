...
/**
 * User-style application. It is self-injected by DiFx, so its own {@code @Inject} injection points resolve even though the instance is
 * not a contextual bean. {@code afterInjection} proves the injected collaborator is available.
 */
